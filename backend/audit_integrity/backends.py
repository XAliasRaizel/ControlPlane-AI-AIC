"""
backend/audit_integrity/backends.py
...
write-once-read-many (WORM) bucket, a separate service -- see the
spec for what Azure SQL Ledger and Certificate Transparency do here.
"""
...
class AuditRecordBackend:
    ...
    def close(self) -> None:
        """Close the underlying SQLite connection. Required on Windows
        before the database file can be deleted."""
        self._conn.close()
